defmodule Core.Authenticator.OAuth.Facebook do
  @moduledoc """
  OAuth2 for Facebook.
  ...
  defp config do
    Application.get_env(:core, :oauth)[:facebook]
  end
  ...
  defp app_id do
    Application.get_env(:core, :oauth)[:facebook][:client_id]
  end

  defp app_secret do
    Application.get_env(:core, :oauth)[:facebook][:client_secret]
  end
end
