defmodule Core.Errors do
  ...
  """
  @spec report(any(), [any()], core_error_params()) :: :ok
  ...
  """
  @spec report_throw(any(), [any()], core_error_params()) :: :ok
  ...
  """
  @spec report_exit(any(), [any()], core_error_params()) :: :ok
  def report_exit(value, stacktrace, params \\ []) do
    do_report(:exit, value, stacktrace, params)
  end

  @spec do_report(:error | :exit | :throw, any(), [any()], core_error_params()) :: :ok
  ...
  defp default_occurrence_data() do
    %{
      "code_version" => Core.Application.version()
    }
  end
